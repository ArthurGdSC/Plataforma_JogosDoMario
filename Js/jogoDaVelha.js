      ...
      function verifica(casa) {
          ...
          if (casas[casa] == 9) {
              ...
              if (vez == 1) {
                  document.getElementById("img" + casa).src = "img/question-block.png"
      
                  //Se o jogador for -1, coloca o desenho da bola
      
              } else {
                  document.getElementById("img" + casa).src = "img/star.png";
      ...
      function confere() {
          ...
          for (i = 0; i < Soma.length; i++) {
              ...
              if (Soma[i] == -3) {
                  lGanhou = true;
                  sResposta = "Estrela GANHOU!!!";
                  iPontosO++;
                  document.getElementById("bola").innerHTML = "Pontos E: " + iPontosO;
                  break;
                  ...
                  lGanhou = true;
                  sResposta = "Bloco GANHOU!!!";
                  iPontosX++;
                  document.getElementById("xis").innerHTML = "PONTOS B: " + iPontosX;
                  break;
              }
          }
