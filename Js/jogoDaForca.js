var sPerguntas = [["MARIO", "PERSONAGENS"], ["LUIGI", "PERSONAGENS"],
["YOSHI", "PERSONAGENS"], ["BOWSER", "PERSONAGENS"],
["PRINCESA PEACH", "PERSONAGENS"], ["TOAD", "PERSONAGENS"],
["WARIO", "PERSONAGENS"], ["WALUIGI", "PERSONAGENS"],
["TOADETTE", "PERSONAGENS"], ["DONKEY KONG", "PERSONAGENS"],
["MAGIKOOPA", "PERSONAGENS"], ["BOWSER JR", "PERSONAGENS"]]
...
function Confere(cLetra) {
    ...
    if (lAchou == false) {
        ...
        document.getElementById("imagem").src = "img/forca/forca" + (iErro + 1) + ".png";
    }
}
//*
